// /components/Toolbox.jsx (Original Click-to-Open Version)
...
const dropdownMenus = {
  ...
  theme: [
    {
      ...
      action: () => alert("Applying Minimalist White Theme"),
    },
    {
      name: "Dark Professional",
      action: () => alert("Applying Dark Professional Theme"),
    },
    {
      name: "Creative Gradient",
      action: () => alert("Applying Creative Gradient Theme"),
    },
    {
      name: "Corporate Blue",
      action: () => alert("Applying Corporate Blue Theme"),
    },
  ],
  ...
  group: [
    {
      ...
      action: () => alert("Grouping selected elements, slides, effects, etc."),
    },
    {
      name: "Ungroup Selected Items",
      action: () => alert("Ungrouping selected elements"),
    },
    {
      name: "Bring to Front (Layer)",
      action: () => alert("Moving layer to front"),
    },
    {
      name: "Send to Back (Layer)",
      action: () => alert("Moving layer to back"),
    },
  ],
  // TRANSITIONS
  transition: [
  ...
  animation: [
    ...
    {
      name: "Entrance: Fly In",
      action: () => alert("Applying Fly In Animation"),
    },
    { name: "Entrance: Zoom", action: () => alert("Applying Zoom Animation") },
    {
      name: "Emphasis: Pulse",
      action: () => alert("Applying Pulse Animation"),
    },
    { name: "Emphasis: Spin", action: () => alert("Applying Spin Animation") },
    {
      name: "Exit: Fade Out",
      action: () => alert("Applying Fade Out Animation"),
    },
  ],
  // ALIGNMENT
  align: [
    ...
    { name: "---", type: "separator" },
    {
      name: "Align Objects to Slide Center",
      action: () => alert("Objects Centered on Slide"),
    },
  ],
  // SHAPES
  shape: [
    ...
    { name: "Insert Circle", action: () => alert("Inserting Circle Shape") },
    {
      ...
      action: () => alert("Inserting Triangle Shape"),
    },
  ...
  image: [
    {
      name: "Search File Explorer...",
      action: () => alert("Opening File Explorer to select image"),
    },
    { name: "Insert from URL", action: () => alert("Prompting for Image URL") },
    {
      name: "Take Screenshot",
      action: () => alert("Activating Screenshot Tool"),
    },
  ],
};
...
const ToolDropdown = ({ items, onClose }) => {
  return (
    // e.stopPropagation() is necessary here to prevent closing when clicking inside the menu
      ...
      <div className="Tool-Bar" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="Tool-Items">
          {toolsToDisplay.map((tool) => (
            <div key={tool.id} className={`Tool-Item-Container ${tool.type}`}>
              <button
              ...
              >
                <tool.icon size={20} />
                {tool.type === "dropdown" && (
                  <FaCaretDown size={10} className="Dropdown-Caret" />
                )}
              </button>
